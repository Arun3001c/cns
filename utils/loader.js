export const load = {
    ...
    assets:() => {
        loadSprite("level1", "./assets/level1.png")
        loadSprite("level2", "./assets/level2.png")
        loadSprite("level3", "./assets/level3.png")
        loadSprite("level4", "./assets/level4.png")
        loadSprite("level5", "./assets/level5.png")
        loadSprite("level6", "./assets/level6.png")
        loadSprite("level7", "./assets/level7.png")
        loadSprite("level8", "./assets/level8.png")
        loadSprite("level9", "./assets/level9.png")
        ...
        loadSprite("forest-background2", "./assets/Forest_Background_0.png")

        loadSprite("forest-background", "./assets/forest-background-1.png")
    ...
    loadSound("bg-sound", "./sounds/Sakura-Girl-Daisy-chosic.com_.mp3")
